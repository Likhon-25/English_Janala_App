...
const displayLevelWord = (words) => {
    ...
    if (words.length == 0) {
        ...
        wordContainer.innerHTML = `
            ...
            <img src="./assets/alert-error.png" alt="No found word" class="mx-auto">
    ...
    words.forEach((word) => {
        ...
        card.innerHTML = `
         <div class="bg-white rounded-xl shadow-sm text-center py-10 px-5 space-y-4 h-full flex flex-col justify-between">
